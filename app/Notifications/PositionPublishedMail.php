...
class PositionPublishedMail extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line('A new position has been added for the Fire Department: ' . $this->department->name)
            ...
            ->line('Thank you for using FD Careers!');
    }
