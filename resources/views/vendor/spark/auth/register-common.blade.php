    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="alert alert-danger" v-if="registerForm.errors.has('notificationForm')">
                    @{{ registerForm.errors.get('notificationForm') }}
                </div>

                <!-- Notification Form -->
                @include('spark::auth.register-notification-form')
            </div>
        </div>
    </div>
</div>
