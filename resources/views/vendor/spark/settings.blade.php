        ...
        <div class="row">
                    ...
                    <div class="panel-body">
                        <div class="spark-settings-tabs">
                            <ul class="nav spark-settings-stacked-tabs" role="tablist">
                                ...
                                <!-- Departments Link -->
                                <li role="presentation" v-show="departments[0]">
                                    <a href="#department" aria-controls="department" role="tab" data-toggle="tab">
                                        <i class="fa fa-fw fa-btn fa-building-o"></i>Departments
                                    </a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="col-md-8">
                <div class="tab-content">
                    ...
                    <!-- Departments -->
                    <div role="tabpanel" class="tab-pane" id="department" v-show="departments[0]">
                        @include('settings.departments')
                    </div>
