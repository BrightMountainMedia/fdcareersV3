                                ...
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        ...
                                        <p style="{{ $style['paragraph'] }}">
                                            As I'm sure you have noticed, we have launched a new version of our website. This new update includes some awesome new features like:
                                        </p>

                                        <ul>
                                            <li>A NEW user <a href="https://www.fdcareers.com/dashboard" title="Dashboard">Dashboard</a>.</li>
                                            <li>The ability to save Positions to your Dashboard.</li>
                                            <li>The ability to mark Positions Applied and keep those pinned to your Dashboard.</li>
                                            <li>An updated user <a href="https://www.fdcareers.com/settings" title="Settings">Settings</a> page.</li>
                                        </ul>

                                        <p style="{{ $style['paragraph'] }}">
                                            We have even updated our payment processor. This update allowed us to give all of you free trials to the new system before you renew your subscription. This would be the perfect time to double-check your <a href="https://www.fdcareers.com/settings#/payment-method" title="Payment Method">Payment Method</a> and make sure that everything is up-to-date. Once the Payment Method is up-to-date, you might want to check out the <a href="https://www.fdcareers.com/settings#/subscription" title="Subscription">Subscription</a> section and verify that the plan you are on is acurate.
                                        </p>
